...
/** Fixed overlay + paper card — exact geometry of the prototype's modals (radius 18, padding 24). */
...
export function FormInput({ value, onChange, placeholder, style, ltr, autoFocus, onEnter }: { value: string; onChange: (v: string) => void; placeholder?: string; style?: React.CSSProperties; ltr?: boolean; autoFocus?: boolean; onEnter?: () => void }) {
  return (
